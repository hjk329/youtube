...
import {
  ...
  MdHome, MdMenu, MdPlayCircleFilled,
...
const AnimationSidebar = ({ sidebar, getAnimationSidebar }) => (

  <Container className={cn({ open: sidebar })}>
    <Logo>
      <Button onClick={getAnimationSidebar}>
        {' '}
        <MdMenu />
        {' '}
      </Button>
