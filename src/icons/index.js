export const IconLogo = () => (
    <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"
         style={{pointerEvents: 'none', display: 'block', width: '90px', height: '20px'}}>
        <g viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" className="style-scope yt-icon">
            <g className="style-scope yt-icon">
                <path
                    ...
                    fill="#FF0000" className="style-scope yt-icon"/>
...
export const IconMusic = () => (
    <img id="img" className="style-scope yt-img-shadow" height="24" width="24" alt=""
